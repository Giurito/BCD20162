...
getDisciplinaselegiveis = function(req, res)
{
    var str = 'select ' + 'codigo' + ' from ' + 'disciplinas_elegiveis_pretty' + ' where ' + req.body.matricula ' = disciplinas_elegiveis_pretty.numero';
...
getCargaHorariacurso = function(req, res)
{
    var str = 'select ' + 'CHmin, CHmax' + ' from ' + 'curso' + ' where ' + req.body.curso ' = curso.nome';
    //var str = getSQLFormat(req.query.disciplinas, 'codigo, CH', 'codigo', 'disciplina');
    ...
    connection.query(str,
        function(err, rows, fields)
        {
            ...
            {
                res.status(200);
                res.json(JSON.parse('{"curso":' + JSON.stringify(rows) + '}'));
            }
            else
            {
                res.status(503);
...
exports.carga_horaria_curso = function(req, res)
{
    getCargaHorariacurso(req, res);
};

exports.disciplinas_elegiveis = function(req, res)
{
    getDisciplinaselegiveis(req, res);
};
