...
app.post('/js/disciplinas_elegiveis', router.disciplinas_elegiveis).all('/js/disciplinas_elegiveis', methodNotAllowed);
app.post('/js/carga_horaria_curso', router.carga_horaria_curso).all('/js/carga_horaria_curso', methodNotAllowed);
